...
st.markdown('<style>input[type="number"] { background-color: rgba(129, 110, 95, 0.8);}</style>', unsafe_allow_html=True)

st.markdown('<style>input[type="button"] { background-color: rgba(129, 110, 95, 0.8);}</style>', unsafe_allow_html=True)
